export class UtilsDataCivilizations {
    public static readonly civilizationsTags: string[] = [
        ...
        "DRAFT_EGYPT_CLEOPATRA_PTOLEMAIC", "DRAFT_EGYPT_RAMSES", "DRAFT_MALI_SUNDIATA_KEITA", "DRAFT_GERMANY_LUDWIG",
        "DRAFT_KOREA_SEJONG", "DRAFT_BYZANTIUM_THEODORA", "DRAFT_ENGLAND_ELIZABETH", "DRAFT_NORWAY_HARALD_VARANGIAN",
        "DRAFT_ENGLAND_VICTORIA_STEAM"
    ];
}
